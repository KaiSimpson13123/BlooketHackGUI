guiRun()
    function guiRun() {
        ...
        .cheat:hover {
            ...
            GUI.style.top = '50px';
            GUI.style.left = '50px';
            GUI.style.border = '3px solid white';
            GUI.style.backdropfilter = 'blur(5px)';
            ...
            header.innerHTML = `<span style="color: #0dc2cf;">Blooket Cheats </span><span style="font-size: 0.75rem">by Kai</span><br>`;
            ...
            minimize.style.border = '3px solid white';
            minimize.innerText = '-';
            minimize.onclick = () => {
            ...
            body.innerHTML = (`<span id="curPageEl" style="font-weight: bold;">${getSite(true) ? `${getSite(true)}` : 'No game detected'}</span><br><span>(Press E to hide)</span><br><br><hr style="width: 80px;"><br>`);
                ...
                if (highlightAnswers) {
                    try {
                        Array.from(document.querySelector('div[class*="answersHolder"').children).forEach(x => {
                            if (reactHandler().memoizedState.question.correctAnswers.includes(x.innerText) || reactHandler().memoizedProps.client.question.correctAnswers.includes(x.innerText)) x.firstChild.style = 'background-color: #32CD32;color: black;';
                            else x.firstChild.style = 'color: black;';
                        });
                    } catch { }
                };
                if (curPage == 'kingdom') {
